...
-- AddForeignKey
ALTER TABLE "Checklist" ADD CONSTRAINT "Checklist_closeCycleId_fkey" FOREIGN KEY ("closeCycleId") REFERENCES "CloseCycle"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
